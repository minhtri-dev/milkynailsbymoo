        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
          <div className="p-10">
            ...
            <p className="max-w-2xl text-lg">
              I&apos;m your cozy home nail tech located in the heart of
              Southeast Melbourne, offering Gel-X and BIAB services,
              specialising in intricate nail art
            </p>
          </div>
          <Link
            href="/portfolio"
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 px-10 lg:flex-row">
          <div className="flex-1 text-center">
            ...
            <p className="text-midnight text-lg leading-relaxed lg:text-xl">
              Hi everyone! I&apos;m Ashley, better known as Moo. I&apos;m here
              to spread my love for decorating nails with beautiful art with all
              of you. I used to get my nails done at salons and leave unhappy
              with the results, mostly because I&apos;ve been told no to certain
              designs I vibed with. So, I thought about it and realised,
              &quot;I&apos;m pretty sure I can do this myself.&quot; After
              deciding university was not for me, I signed up for a master class
              with Nail & Gel Academy, received my certificate, and have been
              honing my skills since.
            </p>
          </div>
