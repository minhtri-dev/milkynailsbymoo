...
interface PlaceholderIconProps { size: string }
...
export default function ImgFallback ({ src, img_size, placeholder_size, style = '' }: { src: string, img_size: number, placeholder_size: string, style?: string }) {
